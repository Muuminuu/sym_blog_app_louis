...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 03 avr. 2024 à 09:26
...
INSERT INTO `post` (`id`, `author_id`, `title`, `content`, `published`, `created_at`, `modified_at`, `slug`, `img`) VALUES
(2, 1, 'tesàjlkjkld kdkl@lmdk test', 'frfeffrfdfdsfsdgtgtgtgqqsaspopopo', 1, '2024-03-26 16:35:07', '2024-04-02 14:43:18', 'tesajlkjkld-kdkl-lmdk-test', 'dragon1-660bfd666312d.jpg'),
(3, 1, 'ma ototot _dkjkjdelk', 'ggtgtflmfjmlfjmlfjzeml', 1, '2024-03-26 16:46:07', '2024-04-02 16:19:38', 'ma-ototot-dkjkjdelk', 'mountain-660c13faa4ff3.jpg'),
(4, 2, 'été', 'qefeqffqe', 1, '2024-03-26 16:48:03', '2024-04-02 14:35:00', 'ete', 'dragon3-660bfb742730e.jpg'),
(7, 2, 'test user mkdljkdmlkm', 'test user post lfkdmkljfmldsfjmdl', 1, '2024-03-28 12:14:42', '2024-04-02 14:17:03', 'test-user-mkdljkdmlkm', 'dragon4-660bf73f9691c.jpg'),
(9, 1, 'New Mountain', 'mountain', 1, '2024-04-02 13:48:07', '2024-04-02 16:23:36', 'New-Mountain', 'mountain-660c14e897b1c.jpg'),
(10, 1, 'new marco', '@marco krocco', 1, '2024-04-02 14:37:13', '2024-04-02 14:37:13', 'new-marco', 'krocco-660bfbf9de625.jpg');
...
INSERT INTO `user` (`id`, `username`, `email`, `roles`, `password`, `is_verified`, `avatar`) VALUES
(1, 'admin', 'admin@admin.com', '[\"ROLE_USER\",\"ROLE_SUPER_ADMIN\",\"ROLE_ADMIN\",\"ROLE_EDITOR\"]', '$2y$13$sENTPgM9uW46.bC2wxzNAeiXbz3d5Cy2pz7c0kWNq6u6Ki/dhM8UK', 0, 'dragon1-660c0c601d254.jpg'),
(2, 'user', 'user@user.com', '[]', '$2y$13$jmrXUE4lBITqPJ6oiwACKO9M.9wanXQ1HAL/f9NZAsdwL9cOK4M6S', 1, 'krocco-660c1a39c0a24.jpg'),
(3, 'editor', 'editor@editor.com', '[\"ROLE_USER\",\"ROLE_EDITOR\"]', '$2y$13$j6E5PCLPbrvsGDT9oF6Z7eyWHKAj5/ICHGBHTssuoaByAyKRsrnwy', 1, 'logo-editor-660c1b118d80f.png'),
(4, 'adamass', 'adam@adam.adam', '[\"ROLE_USER\",\"ROLE_EDITOR\"]', '$2y$13$TIKeih1398J8sqIhfHxANevAVCssvG1CibO/gPSF3/ataTOCVTGNi', 1, 'adamas-660c1b903e3b6.png'),
(6, 'a', 'a@a.fr', '[]', '$2y$13$/ItCbCQReg5Jb9VJI0ns3uWHTpFp77TlSOKLzuLXdDBl6bQvd5dJu', 0, 'mountain-660c05c4dabb8.jpg');
